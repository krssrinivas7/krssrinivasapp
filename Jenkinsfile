...
pipeline{
  ...
  buildDiscarder logRotator(artifactDaysToKeepStr: '', artifactNumToKeepStr: '5', daysToKeepStr: '', numToKeepStr: '5')
    ...
    stages{
        ...
        stage('Deploy'){
            steps{
                bat 'copy "C:\\JENKINSHOME\\workspace\\Multi-Branch_main\\target\\KRS-maven-web-app.war" "C:\\Program Files\\Apache Software Foundation\\Tomcat 9.0\\webapps"\\KRS-maven-web-app.war'
            }
        }
        /*
